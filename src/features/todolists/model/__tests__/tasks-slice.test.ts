...
test("correct task should be created at correct array", () => {
  ...
  const endState = tasksReducer(
    startState,
    createTaskTC.fulfilled({ newTask:task }, "requestId", { todolistId: "todolistId2", title: "juice" }),
  )
...
test("correct task should change its status", () => {
  ...
  const endState = tasksReducer(
    startState,
    updateTaskTC.fulfilled({ task: task }, "requestId", {
      todolistId: "todolistId2",
      taskId: "2",
...
test("array should be created for new todolist", () => {
  const todoList = { id: "todolistId3", title: "CS", addedDate: "", order: 0 }
  const title= "ABC"
